...
fnames = [f"data/preprocessed/{sub}_ave.csv" for sub in r.subject_id]
ave = [pd.read_csv(fname) for fname in fnames]
ave = pd.concat(ave)
...
fnames_tfr = [f"data/preprocessed/{sub}_tfr-ave.csv" for sub in r.subject_id]
ave_tfr = [pd.read_csv(fname) for fname in fnames_tfr]
