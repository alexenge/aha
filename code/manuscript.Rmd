...
Averaged across conditions, P1, N170, and N400 amplitudes differed as a function of the part of the experiment, all *F*s ≥ `r fig1$anov["Part", "P1_f"]`, all *p*s `r fig1$anov["Part", "P1_p"]` (see Table \@ref(tab:tab1)).
In addition, N400 amplitudes differed between the informed and the naive condition averaged across the three parts of the experiment, *F*`r fig1$anov["Condition", "N400_df"]` = `r fig1$anov["Condition", "N400_f"]`, *p* = `r fig1$anov["Condition", "N400_p"]`.
