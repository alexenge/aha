...
Always comparing the semantically informed condition to the naive condition, there were no signicantly large clusters in the pre-insight part (all *p*s $\geq$ `r tfr_min_ps[["I"]]`), the insight part (all *p*s $\geq$ `r tfr_min_ps[["II"]]`), or the post-insight part (all *p*s $\geq$ `r tfr_min_ps[["III"]]`).
