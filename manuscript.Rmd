...
trials <- read_csv(here(output_dir, "trials.csv"), col_types = cols(
  ...
  condition = col_factor(levels = c(
    "Informed", "Naive", "Exclude_informed",
    "Exclude_naive", "Exclude_known", "Exclude_glitch"
  ))
))
...
trials %>%
  filter(condition %in% c("Informed", "Naive", "Exclude_informed")) %>%
  droplevels() -> trials
...
cbind(
  c(`Informed` = 1, `Naive` = -1, `Exclude_informed` = 0),
  c(`Informed` = 1, `Naive` = 0, `Exclude_informed` = -1)
) %>%
  t() %>%
...
In the pre-insight phase, when objects were unfamiliar to participants and presented without keywords, no differences emerged between the semantically informed condition and the naive condition in any of the the ERP components, all $|t|$s < `r max(abs(filter(contrast_table, phase == "Pre-insight" & contrast == "Informed - Naive")$t_value))`, all $p$s `r print_p(min(filter(contrast_table, phase == "Pre-insight" & contrast == "Informed - Naive")$p_value))` (see Figure 1B--D).
...
Semantically informed perception in this phase was associated with enlarged (i.e., more negative) amplitudes in the N170 component, $b$ = `r filter(contrast_table, component == "N170" & phase == "Insight" & contrast == "Informed - Naive")$estimate` µV, $t$(`r print_dof(filter(contrast_table, component == "N170" & phase == "Insight" & contrast == "Informed - Naive")$df)`) = `r filter(contrast_table, component == "N170" & phase == "Insight" & contrast == "Informed - Naive")$t_value`, $p_\text{corr}$ = `r print_p(filter(contrast_table, component == "N170" & phase == "Insight" & contrast == "Informed - Naive")$p_value)`, and reduced (i.e., less negative) amplitudes in the N400 component, $b$ = `r filter(contrast_table, component == "N400" & phase == "Insight" & contrast == "Informed - Naive")$estimate` µV, $t$(`r print_dof(filter(contrast_table, component == "N400" & phase == "Insight" & contrast == "Informed - Naive")$df)`) = `r filter(contrast_table, component == "N400" & phase == "Insight" & contrast == "Informed - Naive")$t_value`, $p_\text{corr}$ `r print_p(filter(contrast_table, component == "N400" & phase == "Insight" & contrast == "Informed - Naive")$p_value)`.
There was no reliable difference between conditions in the P1 component, $b$ = `r filter(contrast_table, component == "P1" & phase == "Insight" & contrast == "Informed - Naive")$estimate` µV, $t$(`r print_dof(filter(contrast_table, component == "P1" & phase == "Insight" & contrast == "Informed - Naive")$df)`) = `r filter(contrast_table, component == "P1" & phase == "Insight" & contrast == "Informed - Naive")$t_value`, $p_\text{corr}$ = `r print_p(filter(contrast_table, component == "P1" & phase == "Insight" & contrast == "Informed - Naive")$p_value)`.
...
As in the insight phase, semantically informed perception was associated with reduced (i.e., less negative) amplitudes in the N400 component, $b$ = `r filter(contrast_table, component == "N400" & phase == "Post-insight" & contrast == "Informed - Naive")$estimate` µV, $t$(`r print_dof(filter(contrast_table, component == "N400" & phase == "Post-insight" & contrast == "Informed - Naive")$df)`) = `r filter(contrast_table, component == "N400" & phase == "Post-insight" & contrast == "Informed - Naive")$t_value`, $p_\text{corr}$ `r print_p(filter(contrast_table, component == "N400" & phase == "Post-insight" & contrast == "Informed - Naive")$p_value)`, while the effect in the N170 component did not recur, $b$ = `r filter(contrast_table, component == "N170" & phase == "Post-insight" & contrast == "Informed - Naive")$estimate` µV, $t$(`r print_dof(filter(contrast_table, component == "N170" & phase == "Post-insight" & contrast == "Informed - Naive")$df)`) = `r filter(contrast_table, component == "N170" & phase == "Post-insight" & contrast == "Informed - Naive")$t_value`, $p_\text{corr}$ = `r print_p(filter(contrast_table, component == "N170" & phase == "Post-insight" & contrast == "Informed - Naive")$p_value)`.
Instead, the P1 component was significantly enlarged (i.e., more positive) in response to objects for which semantically informed perception had taken place, $b$ = `r filter(contrast_table, component == "P1" & phase == "Post-insight" & contrast == "Informed - Naive")$estimate` µV, $t$(`r print_dof(filter(contrast_table, component == "P1" & phase == "Post-insight" & contrast == "Informed - Naive")$df)`) = `r filter(contrast_table, component == "P1" & phase == "Post-insight" & contrast == "Informed - Naive")$t_value`, $p_\text{corr}$ = `r print_p(filter(contrast_table, component == "P1" & phase == "Post-insight" & contrast == "Informed - Naive")$p_value)`.
