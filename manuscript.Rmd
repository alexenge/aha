...
# Define Bonferroni-corrected cluster-level p value threshold
p_cluster <- 0.05 / length(unique(clusters$contrast))
```
...
tfr_plots <- plot_fig2(
  tfr_grand_ave, tfr_clusters, p_cluster, channel_locations
)
