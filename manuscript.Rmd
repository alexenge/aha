...
We then conducted one-sample $t$ tests in a mass-univariate fashion and grouped significant results (cluster-forming threshold $p < .05$) into clusters if they ocurred at neighboring time points, frequencies, or channels.
...
Like the ERP effects, this difference immediately ocurred on the first trial on which the objects were presented together with the critical semantic information, and it recurred when the objects were presented once more without any information.
...
We hope that these measures were effective in ruling out many alternative explanations for the top-down effects that we have observed, thus making a more compelling case against the claim that visually perception is "cognitively impenetrable."
