...
authornote: |
  ...
  We would like to thank Nele Langosch for assistance with data collection and analysis as well as Guido Kiecker for technical support.
...
```{r, figs1, fig.height=11, fig.cap="(ref:figure-s1-caption)", eval=TRUE}
